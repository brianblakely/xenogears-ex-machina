...
// 800b1f78+slot*8 from sources; a mode-zero part variant builds through 80024294.
// Existing-sprite destruction, unknown VM commands and task callbacks fail explicitly,
// never invoke behavior callbacks.
