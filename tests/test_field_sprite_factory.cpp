...
void field_factory_and_task_boundaries() {
    ...
    auto result = field::create_field_sprite(actor, descriptor, arguments, environment, sources,
                                             allocate, release);
    check(
    ...
    allocations.clear();
    result = field::create_field_sprite(actor, descriptor, arguments, environment, sources,
                                        allocate, release);
    ...
    rejects([&] {
        static_cast<void>(field::create_field_sprite(actor, descriptor, arguments, environment,
                                                     sources, allocate, release));
    });
